...
class DataProcessor:
     ...
     @staticmethod
     def input_data():
        """Function for storing data to runtime

        Args:
            None

        Returns:
            strings of user's inputs
        """
     ...
     @staticmethod        
     def sav_data():
        """fuction to save runtime data to file,
...
class FileProcessor:
    ...
    def write_file(file_name, table):
        ...
        objFile = open(strFileName, 'w') #The opposite process of read_file. 
        for row in table:
            lstValues = list(row.values())
            lstValues[0] = str(lstValues[0])
            objFile.write(','.join(lstValues) + '\n') 
    ...
    def create_file(file_name):
        ...
        objFile = open(strFileName, 'x') #create file if needed
        objFile.close()
...
while True:
    ...
    # 3.3 process add a CD
        ...
        lisStr = DataProcessor.input_data()
